...
class Cryptography(commands.Cog):
    ...
    async def decode_caesar_brute(self, ctx: Context, *, message: str):
    ...
    async def decode_gost_magma(
        self, ctx: Context, mode: Literal["CBC", "CFB", "CNT", "ECB"],
        key: str, *, data: str
    ):
        """
    ...
    async def decode_reverse(self, ctx: Context, *, message: str):
        """Reverse text"""
    ...
    async def encode_blake2s(self, ctx: Context, *, message: str):
    ...
    async def encode_crc32(self, ctx: Context, *, message: str):
    ...
    async def encode_gost(self, ctx: Context):
        """
        Russian Federation/Soviet Union GOST
        Межгосударственный стандарт
        From GOsudarstvennyy STandart
    ...
    async def encode_gost_34_12_2015(
        self, ctx: Context, key: str, *, data: str
    ):
        """
        GOST 34.12-2015 128-bit block cipher
    ...
    async def encode_whirlpool(self, ctx: Context, *, message: str):
    ...
    async def sha224(self, ctx: Context, *, message: str):
        """
    ...
    async def sha256(self, ctx: Context, *, message: str):
        """
    ...
    async def sha384(self, ctx: Context, *, message: str):
        """
    ...
    async def sha512(self, ctx: Context, *, message: str):
        """
    ...
    async def sha3_224(self, ctx: Context, *, message: str):
        """
    ...
    async def sha3_256(self, ctx: Context, *, message: str):
        """

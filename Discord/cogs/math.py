...
class Math(commands.Cog):
    ...
    async def differentiate(self, ctx: Context, *, equation: str):
        """
    ...
    async def integrate(self, ctx: Context, *, equation: str):
        """
    ...
    async def integrate_definite(
        self, ctx: Context, lower_limit: str, upper_limit: str, *,
        equation: str
    ):
        '''
    ...
    async def acos(self, ctx: Context, value: float):
        """Arc cosine function"""
    ...
    async def asin(self, ctx: Context, value: float):
        """Arc sine function"""
    ...
    async def cos(self, ctx: Context, value: float):
        """Cosine function"""

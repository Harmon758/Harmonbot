...
class Bot(commands.Bot):
	...
	def __init__(self, command_prefix):
		...
		for credential in ("BATTLE_NET_API_KEY", "BATTLERITE_API_KEY", 
							...
							"DATABASE_PASSWORD", "DISCORD_BOTS_GG_API_TOKEN", "DISCORDBOTS_ORG_API_KEY", "FIXER_API_KEY", 
							"FONO_API_TOKEN", "GOOGLE_API_KEY", "GOOGLE_CUSTOM_SEARCH_ENGINE_ID", "HTTP_SERVER_CALLBACK_URL", 
							"IMGUR_CLIENT_ID", "IMGUR_CLIENT_SECRET", "OMDB_API_KEY", "OSU_API_KEY", "OWM_API_KEY", 
